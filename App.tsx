          ...
          {user ? (
            <>
              ...
              <Stack.Screen
                ...
                options={{ title: 'AssessmentScreen', headerShown: false }}
              />
              <Stack.Screen
                name="AssessmentSelection"
                component={AssessmentSelection}
                options={{ title: 'AssessmentSelection', headerShown: false }}
              />
              <Stack.Screen
                name="ApplyToJob"
              ...
              <Stack.Screen
                name="Portfolio"
                component={Portfolio}
                options={{ title: 'Portfolio', headerShown: false }} // Portfolio, Worker View Screen
              />
              <Stack.Screen
                name="WorkerReviews"
